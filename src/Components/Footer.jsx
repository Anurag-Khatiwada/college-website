          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2 text-sm">
                ...
                <span className="text-blue-200">Thapathali, Kathmandu, Nepal</span>
              </li>
              <li className="flex items-center space-x-2 text-sm">
                ...
                <span className="text-blue-200">+977 1-4261 4567</span>
              </li>
              <li className="flex items-center space-x-2 text-sm">
                <svg className="w-5 h-5 text-blue-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-blue-200">info@kcc.edu.np</span>
              </li>
            </ul>
          </div>
        </div>
